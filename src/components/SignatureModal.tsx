        ...
        <div className="p-5 space-y-5">
          ...
          {summary.length > 0 && (
            <div className="bg-[var(--bg)] rounded-xl p-4 border border-[var(--border)]">
              <p className="text-xs font-medium text-[var(--text-muted)] mb-2">📋 서류 요약</p>
            ...
            <div className="flex flex-col items-center">
              ...
              {employerSig && (
                <div className="w-full mb-4 p-3 bg-green-50 border border-green-200 rounded-lg flex items-center gap-2">
                  ...
                  <span className="text-xs text-green-700 font-medium">사업주 서명 완료</span>
                  <img
                    src={employerSig}
                    alt="사업주 서명"
              ...
              <p className="text-sm font-medium text-[var(--text)] mb-3">👤 근로자 서명</p>
              <SignaturePad
          ...
          <p className="text-[10px] text-[var(--text-muted)] text-center leading-relaxed">
            전자서명은 「전자서명법」에 따라 법적 효력이 있습니다.<br />
            서명 완료 시 해당 서류는 수정할 수 없으며, 서명 이미지가 서류에 포함됩니다.
          </p>
        </div>
      </div>
    </div>
